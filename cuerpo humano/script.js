const questions = [
  {
    ...
    correct: "Corazón",
    options: ["Corazón", "Pulmones", "Estómago"],
    image: "img/corazon.jpg"
  },
  {
    question: "¿Qué sistema nos ayuda a respirar?",
    correct: "Sistema Respiratorio",
    options: ["Sistema Digestivo", "Sistema Nervioso", "Sistema Respiratorio"],
    image: "img/sistema respiratorio.jpg"
  },
  {
    question: "¿Qué parte del cuerpo procesa los alimentos?",
    correct: "Estómago",
    options: ["Pulmones", "Cerebro", "Estómago"],
...
const images = [
  "img/cerebro.jpg",
  "img/corazon humano.jpg",
  "img/sistema respiratorio.jpg",
  "img/stomach.jpg"
];
